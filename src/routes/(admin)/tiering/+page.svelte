...
<div class="row">
    <div class="col-xl-12 col-xxl-12">
      <div class="container">
        <h1 class="text-center mb-4">Tiering Calculator</h1>
        ...
        <form id="tierForm">
            ...
            <button type="button" class="btn w-100 text-white" style="background-color: #224335;" on:click={calculateTier}>Calculate Tier</button>
        </form>
