    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                ...
                <a href="client-add.html" class="add-menu-sidebar">+ New Client</a>
            </div>
            <div class="card-body">
                <div class="table-responsive">
                    <table id="example3" class="display min-w850">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><img class="rounded-circle" width="35" src="./images/profile/small/pic11.jpg" alt=""></td>
                                <td>Pioneers Inc.</td>
                            ...
                            <tr>
                                <td><img class="rounded-circle" width="35" src="./images/profile/small/pic12.jpg" alt=""></td>
                            ...
                            <tr>
                                <td><img class="rounded-circle" width="35" src="./images/profile/small/pic13.jpg" alt=""></td>
                            ...
                            <tr>
                                <td><img class="rounded-circle" width="35" src="./images/profile/small/pic14.jpg" alt=""></td>
                                <td>Digital Works</td>
